...
var _NgxsReduxDevtoolsPlugin = class _NgxsReduxDevtoolsPlugin {
...
__name(_NgxsReduxDevtoolsPlugin, "NgxsReduxDevtoolsPlugin");
/** @nocollapse */
__publicField(_NgxsReduxDevtoolsPlugin, "ɵfac", /* @__PURE__ */ __name(function NgxsReduxDevtoolsPlugin_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NgxsReduxDevtoolsPlugin)();
}, "NgxsReduxDevtoolsPlugin_Factory"));
/** @nocollapse */
__publicField(_NgxsReduxDevtoolsPlugin, "ɵprov", ɵɵdefineInjectable({
  token: _NgxsReduxDevtoolsPlugin,
  factory: _NgxsReduxDevtoolsPlugin.ɵfac
}));
var NgxsReduxDevtoolsPlugin = _NgxsReduxDevtoolsPlugin;
(() => {
...
__name(devtoolsOptionsFactory, "devtoolsOptionsFactory");
var USER_OPTIONS = new InjectionToken("USER_OPTIONS");
var _NgxsReduxDevtoolsPluginModule = class _NgxsReduxDevtoolsPluginModule {
...
__name(_NgxsReduxDevtoolsPluginModule, "NgxsReduxDevtoolsPluginModule");
/** @nocollapse */
__publicField(_NgxsReduxDevtoolsPluginModule, "ɵfac", /* @__PURE__ */ __name(function NgxsReduxDevtoolsPluginModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NgxsReduxDevtoolsPluginModule)();
}, "NgxsReduxDevtoolsPluginModule_Factory"));
/** @nocollapse */
__publicField(_NgxsReduxDevtoolsPluginModule, "ɵmod", ɵɵdefineNgModule({
  type: _NgxsReduxDevtoolsPluginModule
}));
/** @nocollapse */
__publicField(_NgxsReduxDevtoolsPluginModule, "ɵinj", ɵɵdefineInjector({}));
var NgxsReduxDevtoolsPluginModule = _NgxsReduxDevtoolsPluginModule;
(() => {
...
__name(withNgxsReduxDevtoolsPlugin, "withNgxsReduxDevtoolsPlugin");
export {
